  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #0a2342 0%, #1a4a7a 55%, #0d6ebd 100%)' }}
      >
        {/* decorative circles */}
        ...
        <div className="relative space-y-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[{ value: '10+', label: 'Modules' }, { value: '7', label: 'Roles' }, { value: '24/7', label: 'Uptime' }].map((s) => (
          ...
          <div className="space-y-3">
            {['Reception & OPD', 'IPD & Pharmacy', 'Lab & Discharge', 'HR & Finance'].map((m) => (
              <div key={m} className="flex items-center gap-3">
                ...
                <span className="text-blue-100 text-sm">{m}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <p className="text-blue-400 text-xs mt-1">
            Powered by <span className="text-white font-medium">MythoQuantum Explorers Pvt. Ltd.</span>
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {ROLES.map((role) => (
                    <button
                      ...
                      className="flex items-center gap-3 p-4 rounded-2xl border-2 border-gray-100 hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 text-left group"
                    >
            ...
            {step === 2 && (
              <>
                <div className="mb-6">
                  {/* back button */}
                  <button onClick={() => { setStep(1); setError(''); setForm({ email: '', password: '' }); }}
                    className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-blue-600 transition mb-4">
                  ...
                  <div className="flex items-center gap-3 mb-4 p-3 rounded-2xl"
                    ...
                    <div>
                      <p className="text-xs text-blue-500 font-medium">Signing in as</p>
                      <p className="text-sm font-bold text-blue-800">{selectedRoleData?.label}</p>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full text-white font-semibold py-3 rounded-xl text-sm transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none"
          ...
          <div className="text-center mt-6 space-y-1">
            <p className="text-xs text-gray-400">
              Powered by{' '}
              <span className="font-semibold text-gray-600">MythoQuantum Explorers Pvt. Ltd.</span>
            </p>
            <p className="text-xs text-gray-300">&copy; {new Date().getFullYear()} Natik Hospital. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
